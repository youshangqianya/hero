# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
...
# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
# 241 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
...
# 39 "./lib/main/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rtc.h" 2
...
# 242 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c" 2
# 1 "./lib/main/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rcc.h" 1
# 243 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c" 2
# 257 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
#define RTC_TR_RESERVED_MASK ((uint32_t)0x007F7F7F)
#define RTC_DR_RESERVED_MASK ((uint32_t)0x00FFFF3F)
#define RTC_INIT_MASK ((uint32_t)0xFFFFFFFF)
#define RTC_RSF_MASK ((uint32_t)0xFFFFFF5F)
#define RTC_FLAGS_MASK ((uint32_t)(RTC_FLAG_TSOVF | RTC_FLAG_TSF | RTC_FLAG_WUTF | RTC_FLAG_ALRBF | RTC_FLAG_ALRAF | RTC_FLAG_INITF | RTC_FLAG_RSF | RTC_FLAG_INITS | RTC_FLAG_WUTWF | RTC_FLAG_ALRBWF | RTC_FLAG_ALRAWF | RTC_FLAG_TAMP1F | RTC_FLAG_TAMP2F | RTC_FLAG_TAMP3F | RTC_FLAG_RECALPF | RTC_FLAG_SHPF))
...
# 328 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_DeInit(void)
{
...
# 411 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_Init(RTC_InitTypeDef* RTC_InitStruct)
{
  ErrorStatus status = ERROR;
...
# 479 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_WriteProtectionCmd(FunctionalState NewState)
{
...
# 506 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_EnterInitMode(void)
{
...
# 551 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ExitInitMode(void)
{

  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->ISR &= (uint32_t)~((uint32_t)0x00000080);
}
# 573 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_WaitForSynchro(void)
{
...
# 624 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_RefClockCmd(FunctionalState NewState)
{
  ErrorStatus status = ERROR;
...
# 672 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_BypassShadowCmd(FunctionalState NewState)
{
...
# 726 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
  ErrorStatus status = ERROR;
...
# 830 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TimeStructInit(RTC_TimeTypeDef* RTC_TimeStruct)
{
...
# 849 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
...
# 882 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_GetSubSecond(void)
{
  uint32_t tmpreg = 0;
...
# 907 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  uint32_t tmpreg = 0;
  ErrorStatus status = ERROR;
...
# 998 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_DateStructInit(RTC_DateTypeDef* RTC_DateStruct)
{
...
# 1017 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  uint32_t tmpreg = 0;
...
# 1077 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint32_t tmpreg = 0;
...
# 1188 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_AlarmStructInit(RTC_AlarmTypeDef* RTC_AlarmStruct)
{
...
# 1218 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint32_t tmpreg = 0;
...
# 1272 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState)
{
...
# 1366 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_AlarmSubSecondConfig(uint32_t RTC_Alarm, uint32_t RTC_AlarmSubSecondValue, uint32_t RTC_AlarmSubSecondMask)
{
  uint32_t tmpreg = 0;
...
# 1407 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_GetAlarmSubSecond(uint32_t RTC_Alarm)
{
  uint32_t tmpreg = 0;
...
# 1455 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_WakeUpClockConfig(uint32_t RTC_WakeUpClock)
{
...
# 1482 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_SetWakeUpCounter(uint32_t RTC_WakeUpCounter)
{
...
# 1591 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_DayLightSavingConfig(uint32_t RTC_DayLightSaving, uint32_t RTC_StoreOperation)
{
...
# 1618 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_GetStoreOperation(void)
{
  return (((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x00002800))->CR & ((uint32_t)0x00040000));
}
# 1656 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_OutputConfig(uint32_t RTC_Output, uint32_t RTC_OutputPolarity)
{
...
# 1699 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_CalibOutputCmd(FunctionalState NewState)
{
...
# 1731 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_CalibOutputConfig(uint32_t RTC_CalibOutput)
{
...
# 1767 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SmoothCalibConfig(uint32_t RTC_SmoothCalibPeriod,
                                  uint32_t RTC_SmoothCalibPlusPulses,
                                  uint32_t RTC_SmouthCalibMinusPulsesValue)
{
...
# 1843 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TimeStampCmd(uint32_t RTC_TimeStampEdge, FunctionalState NewState)
{
  uint32_t tmpreg = 0;
...
# 1887 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_GetTimeStamp(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_StampTimeStruct,
                                      RTC_DateTypeDef* RTC_StampDateStruct)
{
...
# 1969 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperTriggerConfig(uint32_t RTC_Tamper, uint32_t RTC_TamperTrigger)
{
...
# 1999 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperCmd(uint32_t RTC_Tamper, FunctionalState NewState)
{
...
# 2030 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperFilterConfig(uint32_t RTC_TamperFilter)
{
...
# 2064 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperSamplingFreqConfig(uint32_t RTC_TamperSamplingFreq)
{
...
# 2087 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TamperPinsPrechargeDuration(uint32_t RTC_TamperPrechargeDuration)
{
...
# 2107 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_TimeStampOnTamperDetectionCmd(FunctionalState NewState)
{
...
# 2171 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_WriteBackupRegister(uint32_t RTC_BKP_DR, uint32_t Data)
{
...
# 2192 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
uint32_t RTC_ReadBackupRegister(uint32_t RTC_BKP_DR)
{
  volatile uint32_t tmp = 0;
...
# 2232 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_OutputTypeConfig(uint32_t RTC_OutputType)
{
...
# 2270 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ErrorStatus RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S, uint32_t RTC_ShiftSubFS)
{
  ErrorStatus status = ERROR;
...
# 2386 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ITConfig(uint32_t RTC_IT, FunctionalState NewState)
{
...
# 2436 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
FlagStatus RTC_GetFlagStatus(uint32_t RTC_FLAG)
{
...
# 2474 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ClearFlag(uint32_t RTC_FLAG)
{
...
# 2496 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
ITStatus RTC_GetITStatus(uint32_t RTC_IT)
{
...
# 2538 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
void RTC_ClearITPendingBit(uint32_t RTC_IT)
{
  uint32_t tmpreg = 0;
...
# 2561 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_rtc.c"
static uint8_t RTC_ByteToBcd2(uint8_t Value)
{
  uint8_t bcdhigh = 0;
