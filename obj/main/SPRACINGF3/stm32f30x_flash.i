# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
...
# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
# 76 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
...
# 39 "./lib/main/STM32F30x_StdPeriph_Driver/inc/stm32f30x_flash.h" 2
...
# 77 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c" 2
# 91 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
#define RDPRT_MASK ((uint32_t)0x00000002)
#define WRP01_MASK ((uint32_t)0x0000FFFF)
#define WRP23_MASK ((uint32_t)0xFFFF0000)
# 130 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
void FLASH_SetLatency(uint32_t FLASH_Latency)
{
   uint32_t tmpreg = 0;
...
# 156 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
void FLASH_HalfCycleAccessCmd(FunctionalState NewState)
{
...
# 227 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
void FLASH_Unlock(void)
{
...
# 260 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_ErasePage(uint32_t Page_Address)
{
...
# 298 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_EraseAllPages(void)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 333 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 391 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_ProgramHalfWord(uint32_t Address, uint16_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 482 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
void FLASH_OB_Unlock(void)
{
...
# 521 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_Erase(void)
{
...
# 591 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_EnableWRP(uint32_t OB_WRP)
{
...
# 649 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_RDPConfig(uint8_t OB_RDP)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 714 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 758 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_BOOTConfig(uint8_t OB_BOOT1)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 800 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_VDDAConfig(uint8_t OB_VDDA_ANALOG)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 842 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_SRAMParityConfig(uint8_t OB_SRAM_Parity)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 888 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_OB_WriteUser(uint8_t OB_USER)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 932 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FLASH_Status FLASH_ProgramOptionByteData(uint32_t Address, uint8_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 1025 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
void FLASH_ITConfig(uint32_t FLASH_IT, FunctionalState NewState)
{
...
# 1053 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
FlagStatus FLASH_GetFlagStatus(uint32_t FLASH_FLAG)
{
...
# 1081 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_flash.c"
void FLASH_ClearFlag(uint32_t FLASH_FLAG)
{
