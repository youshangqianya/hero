# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
...
# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
# 123 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
...
# 39 "./lib/main/STM32F30x_StdPeriph_Driver/inc/stm32f30x_spi.h" 2
...
# 124 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c" 2
# 1 "./lib/main/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rcc.h" 1
# 125 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c" 2
# 138 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
#define CR1_CLEAR_MASK ((uint16_t)0x3040)
#define CR2_LDMA_MASK ((uint16_t)0x9FFF)

#define I2SCFGR_CLEAR_MASK ((uint16_t)0xF040)
# 190 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_I2S_DeInit(SPI_TypeDef* SPIx)
{
...
# 257 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_Init(SPI_TypeDef* SPIx, SPI_InitTypeDef* SPI_InitStruct)
{
  uint16_t tmpreg = 0;
...
# 291 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
  ...
  else
  {
    ...
    tmpreg &= ((uint16_t)0x3040);
# 332 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
    tmpreg |= (uint16_t)((uint16_t)(SPI_InitStruct->SPI_Direction | SPI_InitStruct->SPI_Mode) |
                         (uint16_t)((uint16_t)(SPI_InitStruct->SPI_CPOL | SPI_InitStruct->SPI_CPHA) |
                         (uint16_t)((uint16_t)(SPI_InitStruct->SPI_NSS | SPI_InitStruct->SPI_BaudRatePrescaler) |
                         SPI_InitStruct->SPI_FirstBit)));
...
# 391 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void I2S_Init(SPI_TypeDef* SPIx, I2S_InitTypeDef* I2S_InitStruct)
{
...
# 494 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_Cmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
...
# 524 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_TIModeCmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
...
# 550 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void I2S_Cmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
...
# 587 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_DataSizeConfig(SPI_TypeDef* SPIx, uint16_t SPI_DataSize)
{
  uint16_t tmpreg = 0;
...
# 614 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_RxFIFOThresholdConfig(SPI_TypeDef* SPIx, uint16_t SPI_RxFIFOThreshold)
{
...
# 636 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_BiDirectionalLineConfig(SPI_TypeDef* SPIx, uint16_t SPI_Direction)
{
...
# 664 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_NSSInternalSoftwareConfig(SPI_TypeDef* SPIx, uint16_t SPI_NSSInternalSoft)
{
...
# 701 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void I2S_FullDuplexConfig(SPI_TypeDef* I2Sxext, I2S_InitTypeDef* I2S_InitStruct)
{
...
# 752 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_SSOutputCmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
...
# 781 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_NSSPulseModeCmd(SPI_TypeDef* SPIx, FunctionalState NewState)
{
...
# 830 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_SendData8(SPI_TypeDef* SPIx, uint8_t Data)
{
...
# 850 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_I2S_SendData16(SPI_TypeDef* SPIx, uint16_t Data)
{
...
# 964 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_CRCLengthConfig(SPI_TypeDef* SPIx, uint16_t SPI_CRCLength)
{
...
# 984 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_CalculateCRC(SPI_TypeDef* SPIx, FunctionalState NewState)
{
...
# 1025 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
uint16_t SPI_GetCRC(SPI_TypeDef* SPIx, uint8_t SPI_CRC)
{
  uint16_t crcreg = 0;
...
# 1088 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_I2S_DMACmd(SPI_TypeDef* SPIx, uint16_t SPI_I2S_DMAReq, FunctionalState NewState)
{
...
# 1125 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_LastDMATransferCmd(SPI_TypeDef* SPIx, uint16_t SPI_LastDMATransfer)
{
...
# 1224 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_I2S_ITConfig(SPI_TypeDef* SPIx, uint8_t SPI_I2S_IT, FunctionalState NewState)
{
...
# 1260 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
uint16_t SPI_GetTransmissionFIFOStatus(SPI_TypeDef* SPIx)
{

  return (uint16_t)((SPIx->SR & ((uint16_t)0x1800)));
}
# 1275 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
uint16_t SPI_GetReceptionFIFOStatus(SPI_TypeDef* SPIx)
{

  return (uint16_t)((SPIx->SR & ((uint16_t)0x0600)));
}
# 1298 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
FlagStatus SPI_I2S_GetFlagStatus(SPI_TypeDef* SPIx, uint16_t SPI_I2S_FLAG)
{
...
# 1334 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
void SPI_I2S_ClearFlag(SPI_TypeDef* SPIx, uint16_t SPI_I2S_FLAG)
{
...
# 1358 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_spi.c"
ITStatus SPI_I2S_GetITStatus(SPI_TypeDef* SPIx, uint8_t SPI_I2S_IT)
{
