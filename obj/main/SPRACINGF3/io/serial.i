    ...
    portOptions_t options)
{
    ...
    switch(identifier) {
        ...
        case SERIAL_PORT_USART1:
            serialPort = uartOpen(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003800)), callback, baudRate, mode, options);
            break;


        case SERIAL_PORT_USART2:
            serialPort = uartOpen(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004400)), callback, baudRate, mode, options);
            break;


        case SERIAL_PORT_USART3:
            serialPort = uartOpen(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004800)), callback, baudRate, mode, options);
            break;
