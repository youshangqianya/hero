...
static const char * const boardIdentifier = "SRF3";
...
static _Bool processOutCommand(uint8_t cmdMSP)
{
    ...
    case 160:
        headSerialReply(12);
        serialize32((*(uint32_t*)0x1FFFF7AC));
        serialize32((*(uint32_t*)0x1FFFF7B0));
        serialize32((*(uint32_t*)0x1FFFF7B4));
        break;
