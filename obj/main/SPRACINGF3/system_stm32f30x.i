# 1 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
...
# 1 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
# 102 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
...
# 103 "./src/main/target/SPRACINGF3/system_stm32f30x.c" 2

uint32_t hse_value = ((uint32_t)8000000);
# 118 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
#define VECT_TAB_OFFSET 0x0
# 130 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
  uint32_t SystemCoreClock = 72000000;

  volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
# 142 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
void SetSysClock(void);
# 159 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
...
# 198 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = ((uint32_t)0x08000000) | 0x0;

}
# 238 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
...
# 290 "./src/main/target/SPRACINGF3/system_stm32f30x.c"
void SetSysClock(void)
{
