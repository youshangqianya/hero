...
void flashLedsAndBeep(void)
{
    ...
    for (uint8_t i = 0; i < 10; i++) {
        do {} while(0);
        digitalToggle(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), Pin_3);
        delay(25);
        systemBeep(1);
        delay(25);
        systemBeep(0);
...
void init(void)
{
    ...
    beeperConfig_t beeperConfig = {
        .gpioPeripheral = ((uint32_t)0x00080000),
        .gpioPin = Pin_15,
...
# 299 "./src/main/main.c"
    ...
    spiInit(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)));
    spiInit(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)));
# 421 "./src/main/main.c"
