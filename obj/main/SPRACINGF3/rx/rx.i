...
# 1 "./src/main/rx/v202.h" 1
# 18 "./src/main/rx/v202.h"
       

_Bool v202ProtocolInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
_Bool v202DataReceived();
...
# 209 "./src/main/rx/rx.c"
    rxRuntimeConfig.auxChannelCount = rxRuntimeConfig.channelCount - 4;
}
# 230 "./src/main/rx/rx.c"
void serialRxInit(rxConfig_t *rxConfig)
{
    _Bool enabled = 0;
