...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), &cfg);


    digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), Pin_11);
    ...
    for (i = 0; i < rxConfig->spektrum_sat_bind; i++) {
        ...
        digitalLo(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), Pin_11);
