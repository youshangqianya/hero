# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
...
# 1 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
# 36 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
...
# 39 "./lib/main/STM32F30x_StdPeriph_Driver/inc/stm32f30x_pwr.h" 2
...
# 37 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c" 2
# 1 "./lib/main/STM32F30x_StdPeriph_Driver/inc/stm32f30x_rcc.h" 1
# 38 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c" 2
# 51 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
...
# 100 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_DeInit(void)
{
  RCC_APB1PeriphResetCmd(((uint32_t)0x10000000), ENABLE);
  RCC_APB1PeriphResetCmd(((uint32_t)0x10000000), DISABLE);
}
# 114 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_BackupAccessCmd(FunctionalState NewState)
{
...
# 158 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_PVDLevelConfig(uint32_t PWR_PVDLevel)
{
  uint32_t tmpreg = 0;
...
# 219 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_WakeUpPinCmd(uint32_t PWR_WakeUpPin, FunctionalState NewState)
{
...
# 351 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_EnterSleepMode(uint8_t PWR_SLEEPEntry)
{
...
# 391 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_EnterSTOPMode(uint32_t PWR_Regulator, uint8_t PWR_STOPEntry)
{
  uint32_t tmpreg = 0;
...
# 438 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_EnterSTANDBYMode(void)
{
...
# 488 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
FlagStatus PWR_GetFlagStatus(uint32_t PWR_FLAG)
{
...
# 514 "./lib/main/STM32F30x_StdPeriph_Driver/src/stm32f30x_pwr.c"
void PWR_ClearFlag(uint32_t PWR_FLAG)
{
