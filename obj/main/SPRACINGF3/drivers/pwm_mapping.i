...
typedef struct pwmIOConfiguration_s {
    ...
    pwmPortConfiguration_t ioConfigurations[17];
...
# 71 "./src/main/drivers/pwm_mapping.c"
enum {
    MAP_TO_PPM_INPUT = 1,
    MAP_TO_PWM_INPUT,
    MAP_TO_MOTOR_OUTPUT,
...
# 373 "./src/main/drivers/pwm_mapping.c"
...
# 604 "./src/main/drivers/pwm_mapping.c"
...
pwmIOConfiguration_t *pwmInit(drv_pwm_config_t *init)
{
    ...
    for (i = 0; i < 17 && setup[i] != 0xFFFF; i++) {
        uint8_t timerIndex = setup[i] & 0x00FF;
        uint8_t type = (setup[i] & 0xFF00) >> 8;

        const timerHardware_t *timerHardwarePtr = &timerHardware[timerIndex];
# 655 "./src/main/drivers/pwm_mapping.c"
        if (init->useUART3 && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)) && (timerHardwarePtr->pin == ((uint16_t)0x0400) || timerHardwarePtr->pin == ((uint16_t)0x0800)))
            continue;



        if (init->useSoftSerial && timerHardwarePtr->tim == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)))
            continue;
        ...
        if (init->useLEDStrip) {
            if (timerHardwarePtr->tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)))
                continue;

            if (timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)) && timerHardwarePtr->gpioPinSource == ((uint8_t)0x08))
                continue;
        ...
        if (init->useVbat && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)) && timerHardwarePtr->pin == ((uint16_t)0x0010)) {
            continue;
        }



        if (init->useRSSIADC && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)) && timerHardwarePtr->pin == ((uint16_t)0x0004)) {
            continue;
        }



        if (init->useCurrentMeterADC && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)) && timerHardwarePtr->pin == ((uint16_t)0x0020)) {
            continue;
        }
...
# 745 "./src/main/drivers/pwm_mapping.c"
            if ((timerIndex == PWM15 || timerIndex == PWM16) && timerHardwarePtr->tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00004000)))
                type = MAP_TO_SERVO_OUTPUT;
# 771 "./src/main/drivers/pwm_mapping.c"
        }

        if (init->useChannelForwarding && !init->airplane) {
# 785 "./src/main/drivers/pwm_mapping.c"
                if (timerIndex >= PWM5 && timerIndex <= PWM8)
                    type = MAP_TO_SERVO_OUTPUT;

        }
# 805 "./src/main/drivers/pwm_mapping.c"
        if (type == MAP_TO_PPM_INPUT) {
# 816 "./src/main/drivers/pwm_mapping.c"
