...
# 178 "./src/main/drivers/bus_spi.c"
void initSpi2(void)
{
    ...
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x0D), ((uint8_t)0x05));
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x0E), ((uint8_t)0x05));
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x0F), ((uint8_t)0x05));

    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x0C), ((uint8_t)0x05));


    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_Level_3;
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
# 229 "./src/main/drivers/bus_spi.c"
    GPIO_InitStructure.GPIO_Pin = Pin_13 | Pin_14 | Pin_15;
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), &GPIO_InitStructure);



    GPIO_InitStructure.GPIO_Pin = Pin_12;
    ...
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), &GPIO_InitStructure);
# 271 "./src/main/drivers/bus_spi.c"
    SPI_I2S_DeInit(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)));

    spi.SPI_Direction = ((uint16_t)0x0000);
    spi.SPI_Mode = ((uint16_t)0x0104);
    spi.SPI_DataSize = ((uint16_t)0x0700);
    ...
    SPI_RxFIFOThresholdConfig(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((uint16_t)0x1000));

    SPI_Init(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), &spi);
    SPI_Cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ENABLE);


    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), Pin_12);
...
_Bool spiInit(SPI_TypeDef *instance)
{
    ...
    (void)(instance);
# 316 "./src/main/drivers/bus_spi.c"
