# 1 "./src/main/drivers/compass_ak8975.c"
...
# 1 "./src/main/drivers/compass_ak8975.c"
# 18 "./src/main/drivers/compass_ak8975.c"
...
# 19 "./src/main/drivers/compass_ak8975.c" 2
...
# 20 "./src/main/drivers/compass_ak8975.c" 2
...
# 22 "./src/main/drivers/compass_ak8975.c" 2
...
# 24 "./src/main/drivers/compass_ak8975.c" 2
...
# 26 "./src/main/drivers/compass_ak8975.c" 2
...
# 28 "./src/main/drivers/compass_ak8975.c" 2
...
# 29 "./src/main/drivers/compass_ak8975.c" 2
...
# 31 "./src/main/drivers/compass_ak8975.c" 2
...
# 32 "./src/main/drivers/compass_ak8975.c" 2
...
# 33 "./src/main/drivers/compass_ak8975.c" 2
...
# 35 "./src/main/drivers/compass_ak8975.c" 2
...
# 36 "./src/main/drivers/compass_ak8975.c" 2
...
# 38 "./src/main/drivers/compass_ak8975.c" 2
...
# 39 "./src/main/drivers/compass_ak8975.c" 2
...
# 41 "./src/main/drivers/compass_ak8975.c" 2
...
void ak8975Init()
{
    ...
    ack = i2cWrite(0x0C, 0x0a, 0x00);
    delay(20);

    ack = i2cWrite(0x0C, 0x0a, 0x0F);
    delay(10);

    ack = i2cRead(0x0C, 0x10, 3, &buffer[0]);
    delay(10);
    ...
    ack = i2cRead(0x0C, 0x02, 1, &status);
    ack = i2cRead(0x0C, 0x09, 1, &status);


    ack = i2cWrite(0x0C, 0x0a, 0x01);
}
...
_Bool ak8975Read(int16_t *magData)
{
    ...
    ack = i2cRead(0x0C, 0x03, 6, buf);
# 137 "./src/main/drivers/compass_ak8975.c"
    ack = i2cRead(0x0C, 0x09, 1, &status);
    if (!ack) {
        return 0;
    }
