...
# 21 "./src/main/drivers/system_stm32f30x.c" 2
...
# 23 "./src/main/drivers/system_stm32f30x.c" 2
...
# 26 "./src/main/drivers/system_stm32f30x.c" 2
...
void enableGPIOPowerUsageAndNoiseReductions(void)
{
    ...
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &gpio);

    gpio.pin = Pin_All;
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), &gpio);
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0800)), &gpio);
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0C00)), &gpio);
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x1000)), &gpio);
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x1400)), &gpio);
}
