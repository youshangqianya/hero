...
# 31 "/usr/include/newlib/sys/features.h" 3
#define __NEWLIB__ 2
...
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint16_t)0x1000));

    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), command);

    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint16_t)0x1000));
}
...
static uint8_t m25p16_readStatus()
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), in, command, sizeof(command));
...
static _Bool m25p16_readIdentification()
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), in, out, sizeof(out));
...
_Bool m25p16_init()
{
    ...
    spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), 2);
...
void m25p16_eraseSector(uint32_t address)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((void *)0), out, sizeof(out));
...
void m25p16_pageProgramBegin(uint32_t address)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((void *)0), command, sizeof(command));
}

void m25p16_pageProgramContinue(const uint8_t *data, int length)
{
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((void *)0), data, length);
}
...
int m25p16_readBytes(uint32_t address, uint8_t *buffer, int length)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), ((void *)0), command, sizeof(command));
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), buffer, ((void *)0), length);
