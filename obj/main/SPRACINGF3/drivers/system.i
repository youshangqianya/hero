...
static extiCallbackHandlerConfig_t extiHandlerConfigs[2];
...
# 196 "./src/main/drivers/system.c"
    ...
    gpio.pin = ((uint16_t)0x0200);
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &gpio);
# 212 "./src/main/drivers/system.c"
    gpio.pin = ((uint16_t)0x0400);
