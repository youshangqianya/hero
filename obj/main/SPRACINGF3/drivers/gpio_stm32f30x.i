# 1 "./src/main/drivers/gpio_stm32f30x.c"
...
# 1 "./src/main/drivers/gpio_stm32f30x.c"
# 18 "./src/main/drivers/gpio_stm32f30x.c"
...
# 19 "./src/main/drivers/gpio_stm32f30x.c" 2
...
# 20 "./src/main/drivers/gpio_stm32f30x.c" 2
...
# 22 "./src/main/drivers/gpio_stm32f30x.c" 2
...
# 24 "./src/main/drivers/gpio_stm32f30x.c" 2
...
# 26 "./src/main/drivers/gpio_stm32f30x.c" 2
...
void gpioInit(GPIO_TypeDef *gpio, gpio_config_t *config)
{
    ...
    for (pinIndex = 0; pinIndex < 16; pinIndex++) {
        ...
        if (config->pin & pinMask) {
            ...
            GPIO_InitStructure.GPIO_Mode = (config->mode & ((1|2) << 0)) >> 0;

            GPIOSpeed_TypeDef speed = GPIO_Speed_Level_1;
            switch (config->speed) {
                case Speed_10MHz:
            ...
            GPIO_InitStructure.GPIO_OType = (config->mode & ((1|2) << 4)) >> 4;
            GPIO_InitStructure.GPIO_PuPd = (config->mode & ((1|2) << 2)) >> 2;
