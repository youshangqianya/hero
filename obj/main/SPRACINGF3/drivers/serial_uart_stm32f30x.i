...
# 1 "./src/main/drivers/serial_uart_stm32f30x.c"
# 26 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 27 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 38 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 75 "./src/main/drivers/serial_uart_stm32f30x.c"
...
uartPort_t *serialUSART1(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    ...
    s->txDMAChannel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000044));

    s->USARTx = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003800));
    ...
    if (options & SERIAL_BIDIR) {
        ...
        GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x09), ((uint8_t)0x07));
        GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &GPIO_InitStructure);
        if(!(options & SERIAL_INVERTED))
            GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint16_t)0x0200));
    } else {
        if (mode & MODE_TX) {
            GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0200);
            GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x09), ((uint8_t)0x07));
        ...
        if (mode & MODE_RX) {
            ...
            GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x0A), ((uint8_t)0x07));
            GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &GPIO_InitStructure);
        }
    }
...
uartPort_t *serialUSART2(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    ...
    s->USARTx = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004400));
# 191 "./src/main/drivers/serial_uart_stm32f30x.c"
    ...
    if (options & SERIAL_BIDIR) {
        ...
        GPIO_InitStructure.GPIO_OType = (options & SERIAL_INVERTED) ? GPIO_OType_PP : GPIO_OType_OD;
        GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x0E), ((uint8_t)0x07));
        GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &GPIO_InitStructure);
        if(!(options & SERIAL_INVERTED))
            GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint16_t)0x4000));
    } else {
        if (mode & MODE_TX) {
            GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x4000);
            GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x0E), ((uint8_t)0x07));
        ...
        if (mode & MODE_RX) {
            ...
            GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x0F), ((uint8_t)0x07));
            GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &GPIO_InitStructure);
        }
    }
# 233 "./src/main/drivers/serial_uart_stm32f30x.c"
...
uartPort_t *serialUSART3(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    ...
    s->USARTx = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004800));
# 274 "./src/main/drivers/serial_uart_stm32f30x.c"
    ...
    if (options & SERIAL_BIDIR) {
        GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0400);
        GPIO_InitStructure.GPIO_OType = (options & SERIAL_INVERTED) ? GPIO_OType_PP : GPIO_OType_OD;
        GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x0A), ((uint8_t)0x07));
        GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), &GPIO_InitStructure);
        if(!(options & SERIAL_INVERTED))
            GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint16_t)0x0400));
    } else {
        if (mode & MODE_TX) {
            GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0400);
            GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x0A), ((uint8_t)0x07));
        ...
        if (mode & MODE_RX) {
            ...
            GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x0B), ((uint8_t)0x07));
            GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), &GPIO_InitStructure);
        }
    }
# 316 "./src/main/drivers/serial_uart_stm32f30x.c"
...
void DMA1_Channel4_IRQHandler(void)
{
    ...
    DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000044)), DISABLE);
    handleUsartTxDma(s);
}
# 369 "./src/main/drivers/serial_uart_stm32f30x.c"
