# 1 "./src/main/drivers/light_ws2811strip_stm32f30x.c"
...
# 1 "./src/main/drivers/light_ws2811strip_stm32f30x.c"
# 18 "./src/main/drivers/light_ws2811strip_stm32f30x.c"
...
# 19 "./src/main/drivers/light_ws2811strip_stm32f30x.c" 2
...
# 20 "./src/main/drivers/light_ws2811strip_stm32f30x.c" 2
...
# 22 "./src/main/drivers/light_ws2811strip_stm32f30x.c" 2
...
# 24 "./src/main/drivers/light_ws2811strip_stm32f30x.c" 2
...
# 25 "./src/main/drivers/light_ws2811strip_stm32f30x.c" 2
...
# 27 "./src/main/drivers/light_ws2811strip_stm32f30x.c" 2
...
# 28 "./src/main/drivers/light_ws2811strip_stm32f30x.c" 2
# 44 "./src/main/drivers/light_ws2811strip_stm32f30x.c"
void ws2811LedStripHardwareInit(void)
{
    ...
    GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x08), ((uint8_t)0x06));
    ...
    TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), &TIM_TimeBaseStructure);
    ...
    TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), &TIM_OCInitStructure);
    TIM_OC1PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), ((uint16_t)0x0008));


    TIM_CtrlPWMOutputs(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), ENABLE);
    ...
    DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000001C)));

    DMA_StructInit(&DMA_InitStructure);
    DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00))->CCR1;
    ...
    DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000001C)), &DMA_InitStructure);

    TIM_DMACmd(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), ((uint16_t)0x0200), ENABLE);

    DMA_ITConfig(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000001C)), ((uint32_t)0x00000002), ENABLE);
...
void ws2811LedStripDMAEnable(void)
{
    DMA_SetCurrDataCounter(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000001C)), ((24 * 32) + 42));
    TIM_SetCounter(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), 0);
    TIM_Cmd(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00002C00)), ENABLE);
    DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000001C)), ENABLE);
}
