...
# 25 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 27 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 28 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 30 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
void i2cInitPort(I2C_TypeDef *I2Cx)
{
    ...
    if (I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400))) {
        RCC_AHBPeriphClockCmd(((uint32_t)0x00040000) | ((uint32_t)0x00040000), ENABLE);
        RCC_APB1PeriphClockCmd(((uint32_t)0x00200000), ENABLE);
        RCC_I2CCLKConfig(((uint32_t)0x00000010));



        GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x06), ((uint8_t)0x04));
        GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)), ((uint8_t)0x07), ((uint8_t)0x04));
        ...
        I2C_InitStructure.I2C_Mode = ((uint32_t)0x00000000);
        I2C_InitStructure.I2C_AnalogFilter = ((uint32_t)0x00000000);
        I2C_InitStructure.I2C_DigitalFilter = 0x00;
        I2C_InitStructure.I2C_OwnAddress1 = 0x00;
        I2C_InitStructure.I2C_Ack = ((uint32_t)0x00000000);
        I2C_InitStructure.I2C_AcknowledgedAddress = ((uint32_t)0x00000000);
        if (i2cOverClock) {
            I2C_InitStructure.I2C_Timing = 0x00500E30;
        } else {
        ...
        I2C_Init(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), &I2C_InitStructure);

        I2C_Cmd(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), ENABLE);
    }

    if (I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800))) {
        RCC_AHBPeriphClockCmd(((uint32_t)0x00400000) | ((uint32_t)0x00020000), ENABLE);
        RCC_APB1PeriphClockCmd(((uint32_t)0x00400000), ENABLE);
        RCC_I2CCLKConfig(((uint32_t)0x10000020));



        GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x1400)), ((uint8_t)0x06), ((uint8_t)0x04));
        GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint8_t)0x0A), ((uint8_t)0x04));
        ...
        I2C_Init(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), &I2C_InitStructure);
...
{
    if (index == I2CDEV_1) {
        I2Cx = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400));
    } else {
        I2Cx = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800));
    }
    i2cInitPort(I2Cx);
}
...
_Bool i2cWrite(uint8_t addr_, uint8_t reg, uint8_t data)
{
    ...
    while (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00008000)) != RESET) {
        if ((i2cTimeout--) == 0) {
    ...
    I2C_TransferHandling(I2Cx, addr_, 1, ((uint32_t)0x01000000), ((uint32_t)0x00002000));


    i2cTimeout = ((uint32_t)0x1000);
    while (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000002)) == RESET) {
        if ((i2cTimeout--) == 0) {
            return i2cTimeoutUserCallback(I2Cx);
        }
    }
    ...
    i2cTimeout = ((uint32_t)0x1000);
    while (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000080)) == RESET)
    {
        if ((i2cTimeout--) == 0) {
            return i2cTimeoutUserCallback(I2Cx);
        }
    ...
    I2C_TransferHandling(I2Cx, addr_, 1, ((uint32_t)0x02000000), ((uint32_t)0x00000000));
    ...
    i2cTimeout = ((uint32_t)0x1000);
    while (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000020)) == RESET) {
        if ((i2cTimeout--) == 0) {
            return i2cTimeoutUserCallback(I2Cx);
        }
    }
    ...
    I2C_ClearFlag(I2Cx, ((uint32_t)0x00000020));
...
_Bool i2cRead(uint8_t addr_, uint8_t reg, uint8_t len, uint8_t* buf)
{
    ...
    I2C_TransferHandling(I2Cx, addr_, 1, ((uint32_t)0x00000000), ((uint32_t)0x00002000));
    ...
    i2cTimeout = ((uint32_t)0x1000);
    while (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000040)) == RESET) {
        if ((i2cTimeout--) == 0) {
            return i2cTimeoutUserCallback(I2Cx);
        }
    }
    ...
    I2C_TransferHandling(I2Cx, addr_, len, ((uint32_t)0x02000000), (uint32_t)(((uint32_t)0x00002000) | ((uint32_t)0x00000400)));


    while (len) {

        i2cTimeout = ((uint32_t)0x1000);
        while (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000004)) == RESET) {
            if ((i2cTimeout--) == 0) {
                return i2cTimeoutUserCallback(I2Cx);
            }
        }
