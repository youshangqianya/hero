...
# 24 "./src/main/drivers/adc_stm32f30x.c" 2
...
# 29 "./src/main/drivers/adc_stm32f30x.c" 2
...
# 41 "./src/main/drivers/adc_stm32f30x.c"
void adcInit(drv_adc_config_t *init)
{
    ...
    if (init->enableVBat) {
        ...
        adcConfig[ADC_BATTERY].adcChannel = ((uint8_t)0x01);
    ...
    if (init->enableRSSI) {
        ...
        adcConfig[ADC_RSSI].adcChannel = ((uint8_t)0x0C);
    ...
    if (init->enableCurrentMeter) {
        ...
        adcConfig[ADC_CURRENT].adcChannel = ((uint8_t)0x02);
...
# 108 "./src/main/drivers/adc_stm32f30x.c"
    RCC_ADCCLKConfig(((uint32_t)0x000001B0));
    RCC_AHBPeriphClockCmd(((uint32_t)0x00000002) | ((uint32_t)0x10000000), ENABLE);

    DMA_DeInit(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000408)));

    DMA_StructInit(&DMA_InitStructure);
    DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100))->DR;
    ...
    DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000408)), &DMA_InitStructure);

    DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000408)), ENABLE);




    ADC_VoltageRegulatorCmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), ENABLE);
    delay(10);
    ADC_SelectCalibrationMode(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), ((uint32_t)0x00000000));
    ADC_StartCalibration(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)));
    while(ADC_GetCalibrationStatus(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100))) != RESET);
    ADC_VoltageRegulatorCmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), DISABLE);
    ...
    ADC_CommonInit(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), &ADC_CommonInitStructure);
    ...
    ADC_Init(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), &ADC_InitStructure);
    ...
    for (i = 0; i < (ADC_CHANNEL_MAX + 1); i++) {
        ...
        ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), adcConfig[i].adcChannel, rank++, adcConfig[i].sampleTime);
    }

    ADC_Cmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), ENABLE);

    while(!ADC_GetFlagStatus(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), ((uint16_t)0x0001)));

    ADC_DMAConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), ((uint32_t)0x00000002));

    ADC_DMACmd(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), ENABLE);

    ADC_StartConversion(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)));
}
