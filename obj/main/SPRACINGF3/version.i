...
const char * const targetName = "SPRACINGF3";
const char * const shortGitRevision = "b8d1204";
const char * const buildDate = "Feb  3 2018";
const char * const buildTime = "22:56:07";
