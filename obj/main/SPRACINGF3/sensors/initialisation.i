...
{
# 116 "./src/main/sensors/initialisation.c"
    static const extiConfig_t spRacingF3MPUIntExtiConfig = {
            .gpioAHBPeripherals = ((uint32_t)0x00080000),
            .gpioPort = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0800)),
            .gpioPin = Pin_13,
            .exti_port_source = ((uint8_t)0x02),
            .exti_pin_source = ((uint8_t)0x0D),
            .exti_line = ((uint32_t)0x0D),
...
_Bool detectGyro(void)
{
    ...
    switch(gyroHardware) {
        ...
        case GYRO_MPU6050:
            ...
            ;
        case GYRO_L3G4200D:
# 246 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU3050:
# 258 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_L3GD20:
# 270 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU6000:
# 282 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU6500:
# 300 "./src/main/sensors/initialisation.c"
            ;
...
retry:
    ...
    switch (accHardwareToUse) {
        case ACC_DEFAULT:
            ;
        case ACC_ADXL345:
# 358 "./src/main/sensors/initialisation.c"
            ;
        case ACC_LSM303DLHC:
# 369 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6050:
            ...
            ;
        case ACC_MMA8452:
# 396 "./src/main/sensors/initialisation.c"
            ;
        case ACC_BMA280:
# 407 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6000:
# 418 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6500:
# 434 "./src/main/sensors/initialisation.c"
            ;
        case ACC_FAKE:
...
# 497 "./src/main/sensors/initialisation.c"
    switch (baroHardware) {
        case BARO_DEFAULT:
            ;
...
# 576 "./src/main/sensors/initialisation.c"
