...
{
# 107 "./src/main/sensors/sonar.c"
    (void)(batteryConfig);
    static const sonarHardware_t const sonarHardware = {
        .trigger_pin = Pin_0,
        .trigger_gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)),
        .echo_pin = Pin_1,
        .echo_gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)),
        .exti_line = ((uint32_t)0x01),
